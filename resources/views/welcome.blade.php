...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Laravel') }} - Explore Two Islands</title>
    ...
    <body class="min-h-screen">
        @php
            ...
            $featuredFoods = collect([
                ['name' => 'Adobo', 'country' => 'Philippines', 'filename' => 'adobo.png'],
                ['name' => 'Rendang', 'country' => 'Indonesia', 'filename' => 'rendang.png'],
                ['name' => 'Lechon', 'country' => 'Philippines', 'filename' => 'lechon.png'],
                ['name' => 'Nasi Goreng', 'country' => 'Indonesia', 'filename' => 'nasigoreng.png'],
                ['name' => 'Halo-halo', 'country' => 'Philippines', 'filename' => 'halohalo.png'],
                ['name' => 'Gado-gado', 'country' => 'Indonesia', 'filename' => 'gadogado.png'],
                ['name' => 'Lumpia', 'country' => 'Philippines', 'filename' => 'lumpiangshanghai.png'],
                ['name' => 'Satay', 'country' => 'Indonesia', 'filename' => 'sateayam.png']
            ]);
    ...
    <footer class="py-12" style="background: var(--footer-bg); color: var(--footer-text); border-top: 1px solid var(--footer-border)">
            <div class="mx-auto max-w-7xl px-6 text-center">
                <div class="flex items-center justify-center gap-3 mb-6">
                    ...
                    <span class="font-semibold text-lg">Coil Group 1</span>
                </div>
                <p class="mb-4" style="color: var(--text-secondary)">Connecting cultures, creating memories</p>
                <p class="text-sm" style="color: var(--text-secondary)">&copy; 2025 Coil Group 1. All rights reserved.</p>
            </div>
        </footer>
    </body>
</html>
